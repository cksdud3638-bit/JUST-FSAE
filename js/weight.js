...
// Unified ledger owns parts CRUD; vehicle weight calculations remain here.
function renderParts() { renderPartsBudget(); renderWeightDistribution(); }
...
function renderWeightDistribution() {
  const dc = S.driverConfig || {}, fc = S.fuelConfig || {};
